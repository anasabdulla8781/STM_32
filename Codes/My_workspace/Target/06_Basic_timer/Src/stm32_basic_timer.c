...
const CR1_bits CR1_init_config = 		{ .bits = {.CEN = SET_BIT, .ARPE = SET_BIT, .OPM = 0}};
const CR2_bits CR2_init_config = 		{ .bits = {.MMS = 0}};
...
BASIC_TIM TIM6_INIT_CFG = {
		///.CR1 = CR1_init_config.all,
		.CR2 = CR2_init_config,
		.DIER = DIER_init_config,
		.PSC = PSC_init_config,
		.ARR = ARR_init_config
};
