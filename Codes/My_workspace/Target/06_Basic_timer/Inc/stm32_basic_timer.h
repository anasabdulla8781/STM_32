...
typedef struct
{
	...
	volatile ARR_bits ARR;   		// Auto-reload register
...
extern BASIC_TIM TIM6_INIT_CFG;				/// Initial configurations for timer 6, declaration

/// funcion declarations
extern void tim6_init(BASIC_TIM* cfg);		/// initialization of the timer 6
